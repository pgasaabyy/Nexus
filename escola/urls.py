...
urlpatterns = [
    ...
    path('dashboard/secretaria/professores/adicionar/', views.secretaria_professor_adicionar, name='secretaria_professor_adicionar'),
    path('dashboard/secretaria/professores/<int:professor_id>/editar/', views.secretaria_professor_editar, name='secretaria_professor_editar'),
